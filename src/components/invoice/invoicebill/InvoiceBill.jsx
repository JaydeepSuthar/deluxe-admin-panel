		...
		<div className='container flex mx-auto py-5'>
			<div class='overflow-hidden    bg-white border sm:rounded-lg'>
				<div class='bg-white border rounded py-5 '>
						...
						<div class='mt-10 border rounded p-5'>
							<dl class=' md:grid md:grid-cols-2 md:gap-y-10 md:space-y-0'>
								<div class=' border-r-2 mx-5'>
									...
									<dt>
										<p class=' text-lg font-medium leading-6 text-gray-900 font-bold'>
											Deluxe
										</p>
										<p class=' text-sm font-medium leading-6 text-gray-600  mt-2'>
									...
									<dt>
										...
										<div className='mt-3'>
											<p class=' text-sm font-medium leading-6 text-gray-600 '>
												<span className='text-md text-gray-900 mr-4'>
													NAME :-
												</span>{' '}
												CASH SALE (cash-2)
											</p>
					...
					<p className='tw-text-center tw-mt-2 tw-font-bold'>This is system generated no signature required</p>
				</div>
			</div>
		</div>
	);
